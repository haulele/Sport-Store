...
<head>
    ...
    <link href="<?php echo e(url('css/product.css')); ?>" type="text/css" rel="stylesheet"> 
    ...
    <div class="container">
        <div class="row">
            <div class="product-list">
                <div class="row ">
                    <div class="sort py-4 text-right">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3   py-3 ">
                        <div class="product" style="background-color: #E8EBF4; border-radius: 30px; height: 460px;">
                            <a href="#" class="img-prod"><img class="img-fluid mx-auto p-3 d-block"  src="<?php echo e(url('img/Rectangle13.png')); ?>" alt="Colorlib Template">
                            </a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="product" style="background-color: #E8EBF4; border-radius: 30px; height: 460px;">
                            <a href="#" class="img-prod"><img class="img-fluid mx-auto p-3 d-block " src="<?php echo e(url('img/Rectangle13(1).png')); ?>" alt="Colorlib Template">
                            </a>
                            <div class="text py-3 px-3">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="product" style="background-color: #E8EBF4; border-radius: 30px; height: 460px;">
                            <a href="#" class="img-prod"><img class="img-fluid mx-auto p-3 d-block" src="<?php echo e(url('img/Rectangle13(2).png')); ?>" alt="Colorlib Template">
                            </a>
                            <div class="text py-3 px-3">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="product" style="background-color: #E8EBF4; border-radius: 30px; height: 460px;">
                            <a href="#" class="img-prod"><img class="img-fluid mx-auto p-3 d-block" src="<?php echo e(url('img/Rectangle13(3).png')); ?>" alt="Colorlib Template">
                            </a>
                            <div class="text py-3 px-3">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="product" style="background-color: #E8EBF4; border-radius: 30px; height: 460px;">
                            <a href="#" class="img-prod"><img class="img-fluid mx-auto p-3 d-block" src="<?php echo e(url('img/Rectangle13(4).png')); ?>" alt="Colorlib Template">
                            </a>
                            <div class="text py-3 px-3">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="product" style="background-color: #E8EBF4; border-radius: 30px; height: 460px;">
                            <a href="#" class="img-prod"><img class="img-fluid mx-auto p-3 d-block" src="<?php echo e(url('img/Rectangle13(5).png')); ?>" alt="Colorlib Template">
                            </a>
                            <div class="text py-3 px-3">
                                <h3><a href="#"  class="card-name">Áo Khoác Thể thao Nam PUMA</a></h3>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="product" style="background-color: #E8EBF4; border-radius: 30px; height: 460px;">
                            <a href="#" class="img-prod"><img class="img-fluid mx-auto p-3 d-block" src="<?php echo e(url('img/Rectangle13(6).png')); ?>" alt="Colorlib Template">
                            </a>
                            <div class="text py-3 px-3">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="product" style="background-color: #E8EBF4; border-radius: 30px; height: 460px;">
                            <a href="#" class="img-prod"><img class="img-fluid mx-auto p-3 d-block" src="<?php echo e(url('img/Rectangle13(7).png')); ?>" alt="Colorlib Template">
                            </a>
                            <div class="text py-3 px-3">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="product" style="background-color: #E8EBF4; border-radius: 30px; height: 460px;">
                            <a href="#" class="img-prod"><img class="img-fluid mx-auto p-3 d-block" src="<?php echo e(url('img/Rectangle13(8).png')); ?>" alt="Colorlib Template">
                            </a>
                            <div class="text py-3 px-3">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="product" style="background-color: #E8EBF4; border-radius: 30px; height: 460px;">
                            <a href="#" class="img-prod"><img class="img-fluid mx-auto p-3 d-block" src="<?php echo e(url('img/Rectangle13(9).png')); ?>" alt="Colorlib Template">
                            </a>
                            <div class="text py-3 px-3">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="product" style="background-color: #E8EBF4; border-radius: 30px; height: 460px;">
                            <a href="#" class="img-prod"><img class="img-fluid mx-auto p-3 d-block" src="<?php echo e(url('img/Rectangle13(10).png')); ?>" alt="Colorlib Template">
                            </a>
                            <div class="text py-3 px-3">
                                <h3><a href="#"  class="card-name">Áo croptop tập luyện nữ PUMA</a></h3>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="product" style="background-color: #E8EBF4; border-radius: 30px; height: 460px;">
                            <a href="#" class="img-prod"><img class="img-fluid mx-auto p-3 d-block" src="<?php echo e(url('img/Rectangle13(11).png')); ?>" alt="Colorlib Template">
                            </a>
                            <div class="text py-3 px-3">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="product" style="background-color: #E8EBF4; border-radius: 30px; height: 460px;">
                            <a href="#" class="img-prod"><img class="img-fluid mx-auto p-3 d-block" src="<?php echo e(url('img/Rectangle13(12).png')); ?>" alt="Colorlib Template">
                            </a>
                            <div class="text py-3 px-3">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="product" style="background-color: #E8EBF4; border-radius: 30px; height: 460px;">
                            <a href="#" class="img-prod"><img class="img-fluid mx-auto p-3 d-block" src="<?php echo e(url('img/Rectangle13(13).png')); ?>" alt="Colorlib Template">
                            </a>
                            <div class="text py-3 px-3">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="product" style="background-color: #E8EBF4; border-radius: 30px; height: 460px;">
                            <a href="#" class="img-prod"><img class="img-fluid mx-auto p-3 d-block" src="<?php echo e(url('img/Rectangle13(14).png')); ?>" alt="Colorlib Template">
                            </a>
                            <div class="text py-3 px-3">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="product" style="background-color: #E8EBF4; border-radius: 30px; height: 460px;">
                            <a href="#" class="img-prod"><img class="img-fluid mx-auto p-3 d-block" src="<?php echo e(url('img/Rectangle13(15).png')); ?>" alt="Colorlib Template">
                            </a>
                            <div class="text py-3 px-3">
...
</html><?php /**PATH D:\Haule\My Application\xampp\htdocs\Sport-Store\BananasSportStore\resources\views/src/html/product.blade.php ENDPATH**/ ?>