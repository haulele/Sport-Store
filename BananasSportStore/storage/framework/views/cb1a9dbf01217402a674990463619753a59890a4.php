...
<head>
    ...
    <link href="<?php echo e(url('css/contact.css')); ?>" type="text/css" rel="stylesheet"> 
                ...
                <iframe class="col-md-5 py-5 d-flex" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3917.830886617685!2d106.77540651376937!3d10.900453759875269!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3174d8f13bc141f1%3A0x361b7ba2c1152eb7!2zVHLhuqduIEjGsG5nIMSQ4bqhbywgxJDDtG5nIEjDsmEsIETEqSBBbiwgQsOsbmggRMawxqFuZywgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1667063409336!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                    ...
                    <div class="col-md-7 py-2 pl-4 pb-md-3" style="background-color: #E8EBF4; border-radius: 30px; margin: auto;">
                        ...
                        <div class="col-sm-12 ftco-animate">
                            <div class="media">
                                <div class=" d-flex mb-4">
                                    <img class="contact-img" width="50" src="<?php echo e(url('img/Visit.png')); ?>">
                                </div>
                        ...
                        <div class="col-sm-12 ftco-animate">
                            <div class="media">
                                <div class=" d-flex mb-4">
                                    <img class="contact-img" width="50" src="<?php echo e(url('img/Smartphone.png')); ?>">
                                </div>
                                <div class="media-body">
                                    <h5   h5  >HOTLINE: 1900167887</h5>
                                </div>
                            </div>
                        </div>      
                        <div class="col-sm-12 ftco-animate">
                            <div class="media">
                                <div class=" d-flex mb-4">
                                    <img class="contact-img" width="50" src="<?php echo e(url('img/MailAccount.png')); ?>">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="row">
                            <div class="col-sm-2 d-flex col-3 pl-4">
                                <div class="media">
                                    <img class="contact-media-img" width="50" src="<?php echo e(url('img/Facebook.png')); ?>">
                                </div>   
                            </div>   
                            <div class="col-sm-2 d-flex col-3 pl-4">
                                <div class="media">
                                    <img class="contact-media-img" width="50" src="<?php echo e(url('img/Instagram.png')); ?>">
                                </div>
                            </div>
                            <div class="col-sm-2 d-flex col-3 pl-4">
                                <div class="media">
                                    <img class="contact-media-img" width="50" src="<?php echo e(url('img/Twitter.png')); ?>">
                                </div>
                            </div>
                            <div class="col-sm-2 d-flex col-3 pl-4">
                                <div class="media">
                                    <img class="contact-media-img" width="50" src="<?php echo e(url('img/Shopee.png')); ?>">
                                </div>
                            </div>
                        </div>     
                    </div>          
...
</html><?php /**PATH D:\Haule\My Application\xampp\htdocs\Sport-Store\BananasSportStore\resources\views/src/html/contact.blade.php ENDPATH**/ ?>