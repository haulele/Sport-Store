...
<body>
  <main>
    <div class="site-blocks-cover" style="background-image: url(../public/img/Rectangle15.png);">
      <div class="container">
        <div class="site-img">
              <div class="caption">
                  <h3>Giới thiệu</h3>
    ...
    <section class="ftco-section bg-light">
      <div class="container">
        <div class="row">
          <img class="col-md-7 col-lg-5 p-md-5 d-flex " src="../public/img/Rectangle16.png">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <div class="media">
              <div class=" d-flex mb-4">
                <img class="icon-img"  width="60" src="../public/img/Group25.png">
              </div>
          ...
          <div class="col-sm-6">
            <div class="media">
              <div class=" d-flex mb-4">
                <img class="icon-img"  width="60" src="../public/img/CurrencyExchange.png">
              </div>
              <div class="media-body">
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="media">
              <div class=" d-flex mb-4">
                <img class="icon-img"  width="60" src="../public/img/New.png">
              </div>
              <div class="media-body">
          ...
          <div class="col-sm-6">
            <div class="media">
              <div class=" d-flex mb-4">
                <img class="icon-img"  width="60" src="../public/img/Communication.png">
              </div>
              <div class="media-body">
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="media">
              <div class=" d-flex mb-4">
                <img class="icon-img"  width="60" src="../public/img/Checkmark.png">
              </div>
              <div class="media-body">
          ...
          <div class="col-sm-6">
            <div class="media">
              <div class=" d-flex mb-4">
                <img class="icon-img"  width="60" src="../public/img/CashinHand.png">
              </div>
              <div class="media-body">
